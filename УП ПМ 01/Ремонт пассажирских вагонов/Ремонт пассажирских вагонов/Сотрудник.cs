...
namespace Ремонт_пассажирских_вагонов
{
    public partial class Сотрудник : Form
    {
        ...
        private void Вагоны_Click(object sender, EventArgs e)
        {
            Просмотр(0);
        ...
        private void Ремонтные_Работы_Click(object sender, EventArgs e)
        {
            Просмотр(1);
            Фото_Вагона.Visible = false;
            Таблица.Size = new Size(1041, 438);
        ...
        private void Железные_Дороги_Click(object sender, EventArgs e)
        {
            Просмотр(2);
            Фото_Вагона.Visible = false;
            Таблица.Size = new Size(1041, 438);
        ...
        private void Ремонты_Click(object sender, EventArgs e)
        {
            Просмотр(3);
            Фото_Вагона.Visible = false;
            Таблица.Size = new Size(1041, 438);
        ...
        Point Mouse;
        private void Сотрудник_MouseMove(object sender, MouseEventArgs e) // Навигация формы курсором с помощью левой кнопкой мыши
        {
        ...
        private void Сотрудник_MouseDown(object sender, MouseEventArgs e)
        {
            Mouse = new Point(e.X, e.Y);
        }

        private void Сотрудник_Load(object sender, EventArgs e) // Метод вызванный самой программой при добавлении в табличную часть объектов, представленные ниже
        {
